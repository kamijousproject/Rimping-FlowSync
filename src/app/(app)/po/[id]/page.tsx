    ...
    <div className="space-y-5">
      {sp.denied === "paid" && (
        <div className="text-sm bg-amber-50 border border-amber-200 text-amber-800 rounded-lg px-3 py-2">
          Quotation นี้ชำระครบแล้ว ไม่สามารถแก้ไขได้
        </div>
      )}
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          {(() => {
            ...
            if (po.payment_status === "paid" && settledAt) {
              if (diffDays <= 0) {
                return (
                  <div className="text-xs text-green-700 bg-green-50 border border-green-200 rounded-lg px-2 py-1 inline-flex items-center gap-1">
              ...
              return (
                <div className="text-xs text-orange-700 bg-orange-50 border border-orange-200 rounded-lg px-2 py-1 inline-flex items-center gap-1">
            ...
            if (po.payment_status !== "paid" && diffDays > 0) {
              return (
                <div className="text-xs text-red-700 bg-red-50 border border-red-200 rounded-lg px-2 py-1 inline-flex items-center gap-1">
                  <AlertTriangle className="w-3 h-3 shrink-0" />
          ...
          <div className="flex gap-2">
            {isPaid ? (
              <button
                ...
                title="Quotation นี้ชำระครบแล้ว ไม่สามารถแก้ไขได้"
              >
                แก้ไข Quotation
              </button>
            ) : (
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="card p-5">
              <div className="text-xs text-muted">ยอดรวม Quotation</div>
            ...
            <div className="card p-5">
              ...
              {po.status === "cancelled" ? (
                <>
                  ...
                  <div className="text-xs text-red-600 mt-1">Quotation ถูกยกเลิก</div>
                </>
              ) : (
                <>
      ...
      {customerCreditUsages.length > 0 && (
        <div className="card p-5">
          <h3 className="font-semibold mb-3">เครดิตโน๊ตที่ใช้กับ Quotation นี้</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="text-xs text-muted border-b">
                <tr>
